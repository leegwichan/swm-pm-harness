...
```
/draft-proposal debate-zip                              # 신규. inputs/debate-zip/ 전체 RAW 사용
/draft-proposal debate-zip --resume 2026-05-14-1830     # 기존 작업 이어서
/draft-proposal                                          # 프로젝트 목록 안내 후 중단
```

## 입력 소스

- RAW는 항상 `projects/inputs/<project>/**/*.{md,html,txt,png,jpg,jpeg}` 전체를 시간순(파일명 오름차순)으로 묶은 합본.
